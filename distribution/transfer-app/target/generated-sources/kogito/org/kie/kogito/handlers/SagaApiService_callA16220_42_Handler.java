...
public class SagaApiService_callA16220_42_Handler extends org.kie.kogito.process.workitems.impl.DefaultKogitoWorkItemHandler {

    com.example.transfer.workflow.SagaApiService service;

    public SagaApiService_callA16220_42_Handler() {
        this(new com.example.transfer.workflow.SagaApiService());
    }

    @jakarta.inject.Inject()
    public SagaApiService_callA16220_42_Handler(com.example.transfer.workflow.SagaApiService service) {
    ...
    public java.util.Optional<org.kie.kogito.internal.process.workitem.WorkItemTransition> activateWorkItemHandler(org.kie.kogito.internal.process.workitem.KogitoWorkItemManager workItemManager, org.kie.kogito.internal.process.workitem.KogitoWorkItemHandler workItemHandler, org.kie.kogito.internal.process.workitem.KogitoWorkItem workItem, org.kie.kogito.internal.process.workitem.WorkItemTransition transition) {
        java.lang.String Account_B = (java.lang.String) workItem.getParameter("Account_B");
        ...
        org.kie.kogito.internal.process.workitem.WorkItemRecordParameters.recordInputParameters(workItem, "Account_B", "AMT", "EC");
        java.util.Map<java.lang.String, java.lang.Object> result;
        result = java.util.Collections.singletonMap("Result", service.callA16220(Account_B, AMT, EC));
    ...
    public String getName() {
        return "com.example.transfer.workflow.SagaApiService_callA16220_42_Handler";
    }
}
