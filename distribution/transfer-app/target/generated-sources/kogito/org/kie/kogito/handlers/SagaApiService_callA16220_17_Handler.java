...
public class SagaApiService_callA16220_17_Handler extends org.kie.kogito.process.workitems.impl.DefaultKogitoWorkItemHandler {

    com.example.transfer.workflow.SagaApiService service;

    public SagaApiService_callA16220_17_Handler() {
        this(new com.example.transfer.workflow.SagaApiService());
    }

    @jakarta.inject.Inject()
    public SagaApiService_callA16220_17_Handler(com.example.transfer.workflow.SagaApiService service) {
    ...
    public String getName() {
        return "com.example.transfer.workflow.SagaApiService_callA16220_17_Handler";
    }
}
