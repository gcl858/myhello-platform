...
public class MyOpenApiService_callOpenApi_24_Handler extends org.kie.kogito.process.workitems.impl.DefaultKogitoWorkItemHandler {

    com.example.transfer.workflow.MyOpenApiService service;

    public MyOpenApiService_callOpenApi_24_Handler() {
        this(new com.example.transfer.workflow.MyOpenApiService());
    }

    @jakarta.inject.Inject()
    public MyOpenApiService_callOpenApi_24_Handler(com.example.transfer.workflow.MyOpenApiService service) {
    ...
    public String getName() {
        return "com.example.transfer.workflow.MyOpenApiService_callOpenApi_24_Handler";
    }
}
