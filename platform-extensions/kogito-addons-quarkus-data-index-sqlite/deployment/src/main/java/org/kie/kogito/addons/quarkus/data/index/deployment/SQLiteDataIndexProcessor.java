...
/**
 * Quarkus deployment processor for the SQLite Data Index addon.
 *
 * This is the SQLite counterpart of {@code PostgreSQLDataIndexProcessor}.
 * The body is identical: it just registers a feature flag and a DevUI page
 * pointing to the bundled GraphQL UI.
 *
 * SQLite is intended for embedded/dev/test use; the addon has the same
 * shape as the PG / MSSQL variants so the runtime wiring is uniform.
 */
